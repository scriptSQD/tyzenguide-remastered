...
export class HomeComponent implements OnInit, AfterViewInit {
  ...
  previewSights = [
    ...
    },
    {
      ...
      shortDesc:
        "Tyzenhauz's Archive is a place steeped in history. An archive was created with the formation of the Grodno province (1801) and the establishment of the provincial government (1802). In the 1880s, the National Historical Archive was located in the building. In 1900, the building was completely  transferred to the archive of the Hrodno provincial Government. The external look of the archive attracts attention of tourists and residents of Hrodno.",
      imgList: [
